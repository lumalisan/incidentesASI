              ...
              <div class="col-md-12">
                ...
                <form class="border border-light p-5" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-ticket.php">
                  ...
                  <select class="mdb-select md-form colorful-select dropdown-info mt-n1" name="tecnico">
                    ...
                    try {
                      ...
                      while($aux = $resultado->fetch_assoc()) {
                        ?>
                        <option value="<?php echo $aux['id']; ?>" <?php if ($aux['id'] == $categoria['tecnico']) echo "selected"; ?>><?php echo $aux['nombre']; ?></option>
                      <?php }
                    } catch (Exception $e) {
                  ...
                  <select class="mdb-select md-form colorful-select dropdown-info mt-n1" name="estado" required>
                    ...
                    <?php if ($categoria['estado'] == 'inicio') { ?>
                      <option value="inicio" selected>Inicio</option>
                      <option value="asignado">Asignado</option>
                      <option value="en proceso">En proceso</option>
                      <option value="finalizado">Finalizado</option>
                    <?php } else if ($categoria['estado'] == 'asignado') { ?>
