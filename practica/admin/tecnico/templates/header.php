      ...
      <ul>
        ...
        <li class="logo-sn waves-effect py-3">
          <div class="text-center">
            <a href="dashboardTecnico.php" class="pl-0"><img src="../img/ticketmaster.png" width="80%" height="70%"></a>
          </div>
        </li>
          ...
          <ul class="collapsible collapsible-accordion">
            ...
            <li>
              ...
              <div class="collapsible-body">
                <ul>
                  <li>
                    <a href="dashboardTecnico.php" class="waves-effect">Ver tickets asignados</a>
                  </li>
                  <li>
